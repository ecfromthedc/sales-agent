# Rising Tides — Lead Targeting Profile & Scoring Matrix

**Purpose:** This document defines exactly who Rising Tides sells to, what makes a lead high-value, and how to filter 2M+ leads down to the 200 that matter.
...
Label-level relationships where a single point of contact controls budgets for 10-50+ artists.
...
| **Buying Signal** | Active release schedule (1+ releases/month across roster) |
| **Why They Buy** | Need scale fast — 20-50 creators per campaign, can't manage in-house |

**Existing Relationships:**
- Warner Records (51 artists worked)
- Empire (3 artists)
- Atlantic (1 artist)
- Columbia (2 artists)
- Sony Music
...
**Expansion Pattern:** Once RT lands one artist at a label, the play is servicing more of that roster. Always check: "do we already work with someone at this label?"
...
Not direct service clients — these feed into the RT Viral course ($997).
...
When scanning a label's roster to identify which artists RT should pitch campaigns for:
...
When a lead is identified, classify what RT would likely sell them:
...
- Cite real numbers from past RT campaigns
...
## 6. Data Sources for Enrichment

| Source | What It Provides | Refresh Rate |
|--------|-----------------|--------------|
| **CRM** (Labels DB) | Known labels, contacts, relationship status | Real-time |
| **CRM** (Artists DB) | Artists we've worked with, by label | Real-time |
| **Spotify API** | Release dates, monthly listeners, followers, genre, label name | Daily |
| **Gmail/Email** | Past threads with contacts (relationship history) | On-demand |
| **Campaign Tracker** | Past performance data (CPM, views, budget) | On-demand |

### Data Gaps (Need Manual Fill or Scraping)
- Label A&R contact emails (not on Spotify)
- Artist manager contacts (inconsistently available)
- Budget history per label
- Social channel URLs for tracked artists

---

## 7. Lead Funnel (Market Sizing)

Filters applied in order — each stage narrows the pool:
...
**Target output: 50-100 qualified, scored, contextual leads per week** — reviewable in 15 minutes, top 10-20 get outreach.
...
**RT's unfair advantages:**
- Real creator relationships (not a database) — 131 active creators
- Music-industry-only focus (not a generalist shop)
- Mon Rovia as living proof (2M+ Facebook, 1M IG, 1M TikTok — built with RT's own methods)
- $100K/month revenue, 55+ simultaneous campaigns, 8-person team
- Sub-$1.00 CPM track record across 67.8M total campaign views
